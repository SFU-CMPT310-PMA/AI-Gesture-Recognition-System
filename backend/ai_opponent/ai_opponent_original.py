...
class AIOpponent:
   ...
   def __init__(self):
       ...
       self.state_to_index = {"Rock": 0, "Paper": 1, "Scissors": 2}
       self.against_move = {0: 1, 1: 2, 2: 0}  # Rock -> Paper, Paper -> Scissors, Scissors ->Rock
   ...
   def predictNextGesture(self):
       ...
       """
       if self.user_last_gesture is None:
...
class BayesianAIOpponent():
   ...
   def predictNextGesture(self):
       ...
       return next_state #this return the index


   def updateAINextGesture(self, predicted_user_gesture):
       """
       Argument: self = AIOpponent, predicted_user_gesture = int
       Goal: Return a int of the move to play against human
       """
       return self.against_move[predicted_user_gesture]