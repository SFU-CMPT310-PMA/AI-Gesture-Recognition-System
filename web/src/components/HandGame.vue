...
async function sendToBackend(landmarks) {
 ...
 this is why mediapipe called the code multiple times per game.
 */
 roundInProgress = true;

 // setTimeout(() => (roundInProgress = false), 300);
 ...
 try {
   ...
   const ai = toTitleCase(data.ai); // testing bayesian
